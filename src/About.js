  ...
  render(){
    return (
      <Container>
        ...
        <Row>
          <Col lg={8} md={8}>
            <h2 class="text-white"><FontAwesomeIcon icon={faSmile} fixedWidth /> Purpose</h2>
            <p class="text-white">
            ...
            <ul>
              <li class="text-white"><a href="https://who.maps.arcgis.com/apps/opsdashboard/index.html#/c88e37cfc43b4ed3baf977d77e4a0667">WHO: Coronavirus disease (COVID-19) Situation Dashboard</a></li>
              <li class="text-white"><a href="https://coronavirus.jhu.edu/map.html">Coronavirus COVID-19 Global Cases by the Center for Systems Science and Engineering (CSSE) at Johns Hopkins University</a></li>
              <li class="text-white"><a href="https://nssac.bii.virginia.edu/covid-19/dashboard/">University of Virginia Biocomplexity Institute COVID-19 Surveillance Dashboard</a></li>
            </ul>
            <p class="text-white">
        ...
        <Row>
          <Col lg={8} md={8}>
            <h2 class="text-white"><FontAwesomeIcon icon={faCross} fixedWidth /> Backstory</h2>
            <p class="text-white">
        ...
        <Row>
          <Col lg={8} md={8}>
            <h2 class="text-white"><FontAwesomeIcon icon={faUsers} fixedWidth /> Connect</h2>
            <p class="text-white">
